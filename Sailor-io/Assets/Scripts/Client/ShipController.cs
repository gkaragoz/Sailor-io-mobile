...
public class ShipController : ShipEntity
{
	...
	void FixedUpdate()
	{
		...
		if (GameManager.instance.offlineMode)
		{
			...
			_boxCollidersParent.localRotation = Quaternion.Euler(new Vector3(_boxCollidersParent.rotation.eulerAngles.x,
				transform.eulerAngles.y, _boxCollidersParent.rotation.eulerAngles.z));
		}
	}
